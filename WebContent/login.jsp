...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#btnLogin').click(function(e) {
			if ($('#txtUsername').val() == "") {
				$('#txtUsername').attr("placeholder", "Type your username here");
				$('#txtUsername').focus();
				return false;
			}
			if ($('#txtPassword').val() == "") {
				$('#txtUsername').attr("placeholder", "Type your password here");
				$('#txtPassword').focus();
				return false;
			}
			$.ajax({
		...
		$('#btnRegister').click(function(e) {
			...
			if ($('#password').val() == "") {
				$('#password').attr("placeholder", "Type your password here");
				$('#password').focus();
				return false;
			}
			if ($('#repassword').val() != $('#password').val()) {
				$('#repassword').attr("placeholder", "Type your repeat password is not correct");
				$('#repassword').focus();
				return false;
			}
			...
			$.ajax({
				...
				data : {
					txtAction : 'register',
					txtEmail : $('#email').val(),
					txtUsername : $('#username').val(),
					txtPassword : $('#password').val()

				},
				success : function(data, status) {
					if (data == "success"){
						alert("Chuc mung ban dang ky thanh cong");
						location.reload();
					}else {
						...
						<div class="center">
							<h1>
								<i class="ace-icon fa fa-leaf green"></i> <span class="grey"
									id="id-text2">Diễn Đàn Khoa Công Nghệ Thông Tin</span>
							</h1>
							<h4 class="blue" id="id-company-text">&copy; Đại Học Tôn Đức
								Thắng</h4>
						</div>
									...
									<div class="widget-main">
										...
										<form id="frmlogin">
											<fieldset>
												...
												</label> <span id="login_error" class="red"></span>
											...
											<fieldset>
												<label class="block clearfix"> <span
													...
													class="block input-icon input-icon-right"> <input
														...
														class="form-control" placeholder="Repeat password" /> <i
												...
												<span id="register_error" class="red"></span>
												...
												<div class="clearfix">
													...
													<button type="submit" value="register" id="btnRegister"
