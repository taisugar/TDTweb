...
<div class="navbar-buttons navbar-header pull-right" role="navigation">
	<button id="login" class="btn btn-lg btn-success">Login</button>
</div>
<%
	} else {
	...
	<ul class="nav ace-nav">
		...
		<li class="light-blue dropdown-modal"><a data-toggle="dropdown"
			href="#" class="dropdown-toggle"> <img class="nav-user-photo"
				...
				class="user-info"> <small>Welcome,</small> <%=acc.getUsername()%>
			...
			<ul
				...
				<li><a
					href="AccountController?txtAction=logout">
