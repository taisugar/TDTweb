									...
									<div class="message-list" id="message-list">
										<div class="message-item message-unread">
											<label class="inline"> <input type="checkbox"
												...
												class="sender" mabaiviet title="Alex John Red Smith"><%=bv.getChuDe().getTenChude()%>
											</span> <span class="time">1:33 pm</span> <span class="summary">
												<span class="text"><%=bv.getTieuDe()%> </span>
											</span>
										</div>
									</div>
								</div>
		...
		<div class="hide message-content" id="id-message-content">
			<div class="message-header clearfix">
				<div class="pull-left">
					...
					<i class="ace-icon fa fa-star orange2"></i> &nbsp; <img
						...
						src="assets/images/avatars/avatar.png" width="32" /> &nbsp; <a
			...
			<div class="message-attachment clearfix">
				<form id="frmpostandcomment">
					<input type="text" id="txtComment" /> <input type="submit"
						id="btnComment" value="Send" />
				</form>
			</div>
		</div>
		<!-- /.message-content -->
		...
		$('.message-list .message-item:eq(0) .text')
				.on(
						...
						function() {
							...
							$('#inbox-tabs a[href="#inbox"]').parent()
									.removeClass('active');
							//some waiting
							setTimeout(
									function() {
				...
				.on(
						...
						function() {
							...
							setTimeout(function() {
								...
								content.find('.scroll-content').children()
										.unwrap();
